...
*SubkeyApi* | [**subkeyGet**](docs/Api/SubkeyApi.md#subkeyget) | **GET** /subkey | List restricted keys
*SubkeyApi* | [**subkeyIdDelete**](docs/Api/SubkeyApi.md#subkeyiddelete) | **DELETE** /subkey/{id} | Delete a restricted key
*SubkeyApi* | [**subkeyIdGet**](docs/Api/SubkeyApi.md#subkeyidget) | **GET** /subkey/{id} | Get a restricted key by id
*SubkeyApi* | [**subkeyIdRollPost**](docs/Api/SubkeyApi.md#subkeyidrollpost) | **POST** /subkey/{id}/roll | Roll the secrets of a restricted key
*SubkeyApi* | [**subkeyPost**](docs/Api/SubkeyApi.md#subkeypost) | **POST** /subkey | Add a restricted key
*SubkeyApi* | [**subkeyPut**](docs/Api/SubkeyApi.md#subkeyput) | **PUT** /subkey | Update a restricted key
...
- [SubKey](docs/Model/SubKey.md)
- [SubKeyRequest](docs/Model/SubKeyRequest.md)
- [SubKeyUpdate](docs/Model/SubKeyUpdate.md)
- [SubKeyWithSecrets](docs/Model/SubKeyWithSecrets.md)
