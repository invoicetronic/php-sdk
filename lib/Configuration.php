...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'Invoicetronic-PHP-SDK/1.10';
    ...
    {
        $report  = 'PHP SDK (Invoicetronic) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.15.0' . PHP_EOL;
