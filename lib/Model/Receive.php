...
class Receive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets payload
     *
     * @param string|null $payload Xml payloaad. This is the actual xml content, as string. On send, it can be base64 encoded. If it's not, it will be encoded before sending. It is guaranteed to be cyphered at rest.
     *
     * @return self
     */
