 ...
 */
class Receive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Receive';
    ...
    */
    ...
    public function setPayload($payload)
    {
        ...
        if ((mb_strlen($payload) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payload when calling Receive., must be bigger than or equal to 1.');
        }
     ...
     * Sets is_read
     *
     * @param bool|null $is_read Whether the invoice has been read at least once. Set to true only when the invoice is requested with include_payload=true.
     *
     * @return self
     */
