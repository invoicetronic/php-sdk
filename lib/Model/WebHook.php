...
class WebHook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets secret
     *
     * @param string|null $secret The secret used to generate webhook signatures, only returned on creation. You should store this value securely and validate it on every call, to ensure that the caller is InvoiceApi.
     *
     * @return self
     */
     ...
     * Sets events
     *
     * @param string[]|null $events List of events to that trigger the webhook.  See InvoiceApi.SupportedEvents.Available for a list of valid event names.
     *
     * @return self
     */
