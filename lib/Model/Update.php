...
class Update implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state State of the document. These are the possible values, as per the SDI documentation:
     *
     * @return self
     */
     ...
     * Sets is_read
     *
     * @param bool|null $is_read Whether the item has been read at least once.
     *
     * @return self
     */
