...
/**
 * SubKeyUpdate Class Doc Comment
 *
 * @category Class
 * @description A restricted key to update. All the editable fields are replaced: an omitted &#x60;permissions&#x60;, &#x60;company_ids&#x60; or &#x60;cors_origins&#x60; means none.
 * @package  Invoicetronic
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SubKeyUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubKeyUpdate';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling SubKeyUpdate., must be bigger than or equal to 1.');
        }
     ...
     * Sets id
     *
     * @param int|null $id Id of the restricted key to update.
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int|null $version Row version read with the key, for optimistic concurrency: a stale version fails with 422.
     *
     * @return self
     */
