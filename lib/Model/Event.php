...
class Event implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['user_agent']) && (mb_strlen($this->container['user_agent']) > 512)) {
            $invalidProperties[] = "invalid value for 'user_agent', the character length must be smaller than or equal to 512.";
        }
    ...
    public function setMethod($method)
    {
        ...
        if ((mb_strlen($method) < 1)) {
            throw new \InvalidArgumentException('invalid length for $method when calling Event., must be bigger than or equal to 1.');
        }
    ...
    public function setEndpoint($endpoint)
    {
        ...
        if ((mb_strlen($endpoint) < 1)) {
            throw new \InvalidArgumentException('invalid length for $endpoint when calling Event., must be bigger than or equal to 1.');
        }
     ...
     * Sets resource_id
     *
     * @param int|null $resource_id ID of the resource created or modified by this request.
     *
     * @return self
     */
     ...
     * Sets user_agent
     *
     * @param string|null $user_agent User-Agent header from the HTTP request.
     *
     * @return self
     */
    public function setUserAgent($user_agent)
    {
        ...
        if (!is_null($user_agent) && (mb_strlen($user_agent) > 512)) {
            throw new \InvalidArgumentException('invalid length for $user_agent when calling Event., must be smaller than or equal to 512.');
        }
     ...
     * Sets query
     *
     * @param string|null $query Request query. Only used for internal logging, not sent to webhooks.
     *
     * @return self
     */
     ...
     * Sets response_body
     *
     * @param string|null $response_body Response payload. It is guaranteed to be encrypted at rest.
     *
     * @return self
     */
