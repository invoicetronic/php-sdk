 ...
 */
class DatiDDT implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DatiDDT';
    ...
    {
        $this->setIfExists('numero_ddt', $data ?? [], null);
        $this->setIfExists('data_ddt', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['numero_ddt'];
    }

    /**
     * Sets numero_ddt
     *
     * @param string|null $numero_ddt numero_ddt
     *
     * @return self
     */
    public function setNumeroDdt($numero_ddt)
    {
        if (is_null($numero_ddt)) {
            array_push($this->openAPINullablesSetToNull, 'numero_ddt');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('numero_ddt', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['numero_ddt'] = $numero_ddt;
    ...
    {
        return $this->container['data_ddt'];
    }

    /**
     * Sets data_ddt
     *
     * @param \DateTime|null $data_ddt data_ddt
     *
     * @return self
     */
    public function setDataDdt($data_ddt)
    {
        if (is_null($data_ddt)) {
            throw new \InvalidArgumentException('non-nullable data_ddt cannot be null');
        }
        $this->container['data_ddt'] = $data_ddt;
