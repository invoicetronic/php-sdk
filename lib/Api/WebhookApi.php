...
class WebhookApi
{
     ...
     */
    public function webhookGet($page = 1, $page_size = 100, $sort = null, string $contentType = self::contentTypes['webhookGet'][0])
    {
        list($response) = $this->webhookGetWithHttpInfo($page, $page_size, $sort, $contentType);
        return $response;
    }
     ...
     */
    public function webhookGetWithHttpInfo($page = 1, $page_size = 100, $sort = null, string $contentType = self::contentTypes['webhookGet'][0])
    {
        $request = $this->webhookGetRequest($page, $page_size, $sort, $contentType);
     ...
     */
    public function webhookGetAsync($page = 1, $page_size = 100, $sort = null, string $contentType = self::contentTypes['webhookGet'][0])
    {
        return $this->webhookGetAsyncWithHttpInfo($page, $page_size, $sort, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookGetAsyncWithHttpInfo($page = 1, $page_size = 100, $sort = null, string $contentType = self::contentTypes['webhookGet'][0])
    {
        $returnType = '\Invoicetronic\Model\WebHook[]';
        $request = $this->webhookGetRequest($page, $page_size, $sort, $contentType);
     ...
     */
    public function webhookGetRequest($page = 1, $page_size = 100, $sort = null, string $contentType = self::contentTypes['webhookGet'][0])
    {
     ...
     */
    public function webhookhistoryGet($page = 1, $page_size = 100, $sort = null, string $contentType = self::contentTypes['webhookhistoryGet'][0])
    {
        list($response) = $this->webhookhistoryGetWithHttpInfo($page, $page_size, $sort, $contentType);
        return $response;
    }
     ...
     */
    public function webhookhistoryGetWithHttpInfo($page = 1, $page_size = 100, $sort = null, string $contentType = self::contentTypes['webhookhistoryGet'][0])
    {
        $request = $this->webhookhistoryGetRequest($page, $page_size, $sort, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookhistoryGetAsync($page = 1, $page_size = 100, $sort = null, string $contentType = self::contentTypes['webhookhistoryGet'][0])
    {
        return $this->webhookhistoryGetAsyncWithHttpInfo($page, $page_size, $sort, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookhistoryGetAsyncWithHttpInfo($page = 1, $page_size = 100, $sort = null, string $contentType = self::contentTypes['webhookhistoryGet'][0])
    {
        $returnType = '\Invoicetronic\Model\WebHookHistory[]';
        $request = $this->webhookhistoryGetRequest($page, $page_size, $sort, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhookhistoryGetRequest($page = 1, $page_size = 100, $sort = null, string $contentType = self::contentTypes['webhookhistoryGet'][0])
    {
