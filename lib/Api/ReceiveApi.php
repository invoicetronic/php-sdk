...
class ReceiveApi
{
     ...
     * @throws \Invoicetronic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Invoicetronic\Model\Receive|\Invoicetronic\Model\ProblemHttpResult|\Invoicetronic\Model\ProblemHttpResult|\Invoicetronic\Model\ProblemHttpResult
     */
     ...
     * @throws \Invoicetronic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Invoicetronic\Model\Receive|\Invoicetronic\Model\ProblemHttpResult|\Invoicetronic\Model\ProblemHttpResult|\Invoicetronic\Model\ProblemHttpResult, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    /**
     * Operation receiveIdPayloadGet
     *
     * Get a receive invoice payload by id
     *
     * @param  int $id Item id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['receiveIdPayloadGet'] to see the possible values for this operation
     *
     * @throws \Invoicetronic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function receiveIdPayloadGet($id, string $contentType = self::contentTypes['receiveIdPayloadGet'][0])
    {
        $this->receiveIdPayloadGetWithHttpInfo($id, $contentType);
    }

    /**
     * Operation receiveIdPayloadGetWithHttpInfo
     *
     * Get a receive invoice payload by id
     *
     * @param  int $id Item id (required)
     ...
     */
    public function receiveIdPayloadGetWithHttpInfo($id, string $contentType = self::contentTypes['receiveIdPayloadGet'][0])
    {
        $request = $this->receiveIdPayloadGetRequest($id, $contentType);
    ...
    /**
     * Operation receiveIdPayloadGetAsync
     *
     * Get a receive invoice payload by id
     *
     * @param  int $id Item id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function receiveIdPayloadGetAsync($id, string $contentType = self::contentTypes['receiveIdPayloadGet'][0])
    {
        return $this->receiveIdPayloadGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation receiveIdPayloadGetAsyncWithHttpInfo
     *
     * Get a receive invoice payload by id
     *
     * @param  int $id Item id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function receiveIdPayloadGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['receiveIdPayloadGet'][0])
    {
        $returnType = '';
        $request = $this->receiveIdPayloadGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'receiveIdPayloadGet'
     *
     * @param  int $id Item id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['receiveIdPayloadGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function receiveIdPayloadGetRequest($id, string $contentType = self::contentTypes['receiveIdPayloadGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling receiveIdPayloadGet'
            );
        }


        $resourcePath = '/receive/{id}/payload';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
