...
class ReceiveApi
{
     ...
     */
    public function receiveGet($company_id = null, $identifier = null, $unread = null, $committente = null, $prestatore = null, $file_name = null, $last_update_from = null, $last_update_to = null, $date_sent_from = null, $date_sent_to = null, $document_date_from = null, $document_date_to = null, $document_number = null, $page = 1, $page_size = 100, $sort = null, string $contentType = self::contentTypes['receiveGet'][0])
    {
        list($response) = $this->receiveGetWithHttpInfo($company_id, $identifier, $unread, $committente, $prestatore, $file_name, $last_update_from, $last_update_to, $date_sent_from, $date_sent_to, $document_date_from, $document_date_to, $document_number, $page, $page_size, $sort, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->receiveGetRequest($company_id, $identifier, $unread, $committente, $prestatore, $file_name, $last_update_from, $last_update_to, $date_sent_from, $date_sent_to, $document_date_from, $document_date_to, $document_number, $page, $page_size, $sort, $contentType);
    ...
    {
        return $this->receiveGetAsyncWithHttpInfo($company_id, $identifier, $unread, $committente, $prestatore, $file_name, $last_update_from, $last_update_to, $date_sent_from, $date_sent_to, $document_date_from, $document_date_to, $document_number, $page, $page_size, $sort, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function receiveIdGet($id, string $contentType = self::contentTypes['receiveIdGet'][0])
    {
        list($response) = $this->receiveIdGetWithHttpInfo($id, $contentType);
        return $response;
    }
     ...
     */
    public function receiveIdGetWithHttpInfo($id, string $contentType = self::contentTypes['receiveIdGet'][0])
    {
        $request = $this->receiveIdGetRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function receiveIdGetAsync($id, string $contentType = self::contentTypes['receiveIdGet'][0])
    {
        return $this->receiveIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function receiveIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['receiveIdGet'][0])
    {
        $returnType = '\Invoicetronic\Model\Receive';
        $request = $this->receiveIdGetRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function receiveIdGetRequest($id, string $contentType = self::contentTypes['receiveIdGet'][0])
    {
