...
class LogApi
{
     ...
     */
    public function logGet($company_id = null, $endpoint = null, $method = null, $api_verion = null, $status_code = null, $date_created_from = null, $date_created_to = null, $page = 1, $page_size = 100, $sort = null, $query = null, $success = null, $date_time_from = null, $date_time_to = null, $user_agent = null, string $contentType = self::contentTypes['logGet'][0])
    {
        list($response) = $this->logGetWithHttpInfo($company_id, $endpoint, $method, $api_verion, $status_code, $date_created_from, $date_created_to, $page, $page_size, $sort, $query, $success, $date_time_from, $date_time_to, $user_agent, $contentType);
        return $response;
    }
     ...
     */
    public function logGetWithHttpInfo($company_id = null, $endpoint = null, $method = null, $api_verion = null, $status_code = null, $date_created_from = null, $date_created_to = null, $page = 1, $page_size = 100, $sort = null, $query = null, $success = null, $date_time_from = null, $date_time_to = null, $user_agent = null, string $contentType = self::contentTypes['logGet'][0])
    {
        $request = $this->logGetRequest($company_id, $endpoint, $method, $api_verion, $status_code, $date_created_from, $date_created_to, $page, $page_size, $sort, $query, $success, $date_time_from, $date_time_to, $user_agent, $contentType);
     ...
     */
    public function logGetAsync($company_id = null, $endpoint = null, $method = null, $api_verion = null, $status_code = null, $date_created_from = null, $date_created_to = null, $page = 1, $page_size = 100, $sort = null, $query = null, $success = null, $date_time_from = null, $date_time_to = null, $user_agent = null, string $contentType = self::contentTypes['logGet'][0])
    {
        return $this->logGetAsyncWithHttpInfo($company_id, $endpoint, $method, $api_verion, $status_code, $date_created_from, $date_created_to, $page, $page_size, $sort, $query, $success, $date_time_from, $date_time_to, $user_agent, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function logGetAsyncWithHttpInfo($company_id = null, $endpoint = null, $method = null, $api_verion = null, $status_code = null, $date_created_from = null, $date_created_to = null, $page = 1, $page_size = 100, $sort = null, $query = null, $success = null, $date_time_from = null, $date_time_to = null, $user_agent = null, string $contentType = self::contentTypes['logGet'][0])
    {
     ...
     */
    public function logGetRequest($company_id = null, $endpoint = null, $method = null, $api_verion = null, $status_code = null, $date_created_from = null, $date_created_to = null, $page = 1, $page_size = 100, $sort = null, $query = null, $success = null, $date_time_from = null, $date_time_to = null, $user_agent = null, string $contentType = self::contentTypes['logGet'][0])
    {
